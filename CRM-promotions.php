   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center" onclick="AQLpage()">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center" onclick="addIpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/ingredientquantity.png">
          ...
          <div class=" flex relative  hover:bg-amber-300/50  shadow-sm cursor-pointer btn-group dropend" >
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="leaveFdbkpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/POSFB.png">
                                                        ...
                                                        <!-- Side Nav - CRM -->
          <div class="text-blue-400 flex relative  hover:bg-amber-300/50 bg-amber-300/50 cursor-pointer btn-group dropend">
            ...
            <div class="flex-auto  my-3 btn-secondary selected" onclick="CRMpage()">
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="websitefdbkpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/members.png">
                                                            ...
                                                            <!-- CRM dropdown Option 3-->
    <li class=" flex relative hover:bg-amber-300/50 text-center bg-amber-300/50" onclick="promotionspage()">
...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex items-start p-4 h-12" >
        ...
        ">Customer Relations Management</span>
                                                          <!-- page links -->
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="CRMpage()">
          <span>CRM</span>
        </button>

        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="LPpage()">
          <span>Loyalty Program</span>
        </button>

        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="instorefdbkpage()">
          <span>Instore Feedback</span>
        </button>

        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="websitefdbkpage()">
          <span>Website Feedback</span>
        </button>

        <button class="mx-3  border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 " style="  font-family: 'Bebas Neue'; " onclick="promotionspage()">
          <span>Promotions</span>
        </button>

        <button class="mx-3 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 " style="  font-family: 'Bebas Neue'; " onclick="mailpage()">
          <span>Mail</span>
        </button>
...
if (isset($_GET['message'])) {
  ...
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
   ...
   Error inserting promotion! Tell admin to check console!
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    } 
 ...
 ?>
<?php include('functions/CRM/promotions.php'); ?>
