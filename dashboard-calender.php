          ...
          <li class="p-4 w-full flex relative shadow-sm bg-gradient-to-r from-amber-500 via-amber-400 to-amber-300  border-amber-300 border-y-2 border-amber-300 ">
            <div class="flex-auto my-1 text-center">
              <span   class=" bg-gradient-to-t from-slate-50 to-slate-50 bg-clip-text text-transparent text-3xl" style="  font-family: 'Bebas Neue';"><?= $role['role'] ?></span>
                                                ...
                                                <!-- Side Nav - Dashboard -->
          <div class="text-blue-400 flex relative z-[1000]  hover:bg-amber-300/50 cursor-pointer btn-group dropend bg-amber-300/50 shadow-sm"  >
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72 ">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center bg-amber-300/50" onclick="calenderpage()">
...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        ...
        <button class="mx-3 border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="calenderpage()">
          <span>Calendar</span>
        </button>
...
<?php include('functions/dashboard/calendar.php'); ?>
