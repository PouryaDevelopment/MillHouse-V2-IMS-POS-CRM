...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center bg-amber-300/50" onclick="salesreportpage()">
...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        ...
        <button class="mx-3  border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="salesreportpage()">
...
<?php include('functions/analytics/salesreport.php'); ?>
