...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        <button class="mx-3  border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="managementpage()">
...
<?php include('functions/management/management.php'); ?>
