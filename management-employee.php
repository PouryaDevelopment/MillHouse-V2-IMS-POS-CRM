<?php 
  ...
  if (!isset($_SESSION['IMS_user_role']) || $_SESSION['IMS_user_role'] !== 'Manager') {
    header('Location: dashboard.php?message=permissionfailure');
    exit();
}
   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="AQLpage()">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="addIpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/ingredientquantity.png">
          ...
          <div class=" flex relative  hover:bg-amber-300/50   cursor-pointer btn-group dropend" >
            ...
            <div class="flex-auto  my-3 btn-secondary " onclick="POSpage()">
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="recieptpage()">
   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="websitefdbkpage()">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center " onclick="mailpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/mail.png">
          ...
          <div class="text-blue-400 flex relative  hover:bg-amber-300/50 cursor-pointer btn-group dropend bg-amber-300/50 shadow-sm">
            ...
            <div class="flex-auto  my-3 btn-secondary selected" onclick="managementpage()">
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
    ...
    <li class=" flex relative hover:bg-amber-300/50 text-center bg-amber-300/50" onclick="employeepage()">
...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="managementpage()">
          <span>Management</span>
        </button>

        <button class="mx-3 border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="employeepage()">
          <span>Employees</span>
        </button>

        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="Addemployeepage()">
          <span>Add Employee</span>
        </button>

          <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="LRpage()">
          <span>Login Requests</span>
        </button>

          <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="schedulepage()">
          <span>Schedule</span>
        </button>
        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="addshiftpage()">
          <span>Add Shift</span>
        </button>
      </div>
  ...
  <div id="content_container" class="h-[850px] w-full  overflow-x-hidden  text-center p-2" style="  font-family: 'Bebas Neue'; overflow-x: auto; ">
     <?php
...
if (isset($_GET['message'])) {
  ...
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    if ($reqmessage == "failure") {
         echo '<div id="ALERT" class="alert alert-danger alert-dismissible fade show  text-center  bg-gradient-to-r from-amber-200/25 via-amber-100/25 to-amber-200/25  shadow-inner rounded-bl-full border-stone-500/25 mt-0  p-0 font-mono font-extralight text-stone-500 "  role="alert">
   Selected employee has a schedule entry. Remove all schedule entries for employee to continue.
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    }    
    if ($reqmessage == "updatefailure") {
         echo '<div id="ALERT" class="alert alert-danger alert-dismissible fade show  text-center  bg-gradient-to-r from-amber-200/25 via-amber-100/25 to-amber-200/25  shadow-inner rounded-bl-full border-stone-500/25 mt-0  p-0 font-mono font-extralight text-stone-500 "  role="alert">
   Please enter a correct branch id! 1-4
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    }  
}
 ?>
<?php include('functions/management/employeetable.php'); ?>
