...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center"onclick="feedbackreportpage()">
      ...
      <img class=" fill-current  h-10 w-10 flex justify-center  " focusable="false"  src="./UI/feedbackreport.png">
                                                    ...
                                                    <!-- Side Nav - Inventory -->
          <div class="text-blue-400 flex relative bg-amber-300/50  hover:bg-amber-300/50 cursor-pointer btn-group dropend shadow-sm" >
            ...
            <div class="flex-auto  my-3 btn-secondary selected" onclick="inventorypage()">
...
<ul class="p-0 dropdown-menu bg-[#ffecc4] backdrop-filter backdrop-blur-lg rounded-none shadow-sm border-amber-300/25 w-72">
   ...
   <li class=" flex relative hover:bg-amber-300/50 text-center bg-amber-300/50" onclick="AQLpage()">
...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="inventorypage()">
          <span>Inventory</span>
        </button>

        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="ANPpage()">
          <span>New Product</span>
        </button>

        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="quantitypage()">
          <span>View Quantity</span>
        </button>

        <button class="mx-3 border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="AQLpage()">
          <span>Add Quantity</span>
        </button>

        <button class="mx-3   transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 " style="  font-family: 'Bebas Neue'; " onclick="ingredientspage()">
          <span>Ingredients</span>
        </button>

        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 " style="  font-family: 'Bebas Neue'; " onclick="addIpage()">
...
if (isset($_GET['message'])) {
  ...
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
   ...
   Failed to set, contact manager.
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    } 
    if ($reqmessage == "existfailure") {
         echo '<div id="ALERT" class="alert alert-danger alert-dismissible fade show  text-center  bg-gradient-to-r from-amber-200/25 via-amber-100/25 to-amber-200/25  shadow-inner rounded-bl-full border-stone-500/25 mt-0  p-0 font-mono font-extralight text-stone-500 "  role="alert">
   The quantity for that product has already been set, please check the view quantity section.
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    } 
 ...
 ?>
<?php include('functions/inventory/AQL.php'); ?>
