...
<img class="h-6 w-6"  src="./UI/notification.png">
    ...
    <div class="text-black  p-1  
      ...
      <div class="flex overflow-hidden h-6 ml-12 justify-end tracking-wide  sm:invisible md:invisible lg:invisible xl:invisible 2xl:visible" >
        <button class="mx-3  border-b-2 border-amber-300 transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="inventorypage()">
          <span>Inventory</span>
        </button>
        ...
        <button class="mx-3  transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0" style="  font-family: 'Bebas Neue'; " onclick="AQLpage()">
...
if (isset($_GET['message'])) {
  ...
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
   ...
   Failed to update. Make sure you use the right data type or the column entry wont be saved.
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    } 

if ($reqmessage == "quantityfail") {
         echo '<div id="ALERT" class="alert alert-danger alert-dismissible fade show  text-center  bg-gradient-to-r from-amber-200/25 via-amber-100/25 to-amber-200/25  shadow-inner rounded-bl-full border-stone-500/25 mt-0  p-0 font-mono font-extralight text-stone-500 "  role="alert">
   Product quantity exists. To delete this product you need to delete its quantity.
  <button type="button" class="btn-close p-1" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
    } 
 ...
 ?>
<?php include('functions/inventory/product_table.php'); ?>
